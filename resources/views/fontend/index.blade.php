...
<head>
    ...
    =============================================
    -->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset("assets/fontend/images/favicons/apple-icon-57x57.png") }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset("assets/fontend/images/favicons/apple-icon-60x60.png") }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset("assets/fontend/images/favicons/apple-icon-72x72.png") }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset("assets/fontend/images/favicons/apple-icon-76x76.png") }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset("assets/fontend/images/favicons/apple-icon-114x114.png") }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset("assets/fontend/images/favicons/apple-icon-120x120.png") }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset("assets/fontend/images/favicons/apple-icon-144x144.png") }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset("assets/fontend/images/favicons/apple-icon-152x152.png") }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset("assets/fontend/images/favicons/apple-icon-180x180.png") }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset("assets/fontend/images/favicons/android-icon-192x192.png") }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset("assets/fontend/images/favicons/favicon-32x32.png") }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset("assets/fontend/images/favicons/favicon-96x96.png") }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset("assets/fontend/images/favicons/favicon-16x16.png") }}">
{{--    <link rel="manifest" href="/manifest.json">--}}
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="assets/fontend/images/favicons/ms-icon-144x144.png">
...
<main>
   @include('fontend.layouts.menu')
    <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" id="home" data-background="{{ asset("assets/fontend/images/agency/agency_bg.jpg") }}">
    ...
    <div class="main">
        ...
        <section class="module pt-0 pb-0" id="about">
            <div class="row position-relative m-0">
                <div class="col-xs-12 col-md-6 side-image" data-background="{{ asset('assets/fontend/images/section-14.jpg') }}">
            ...
            <div class="container">
                ...
                <ul class="works-grid works-grid-gut works-grid-3 works-hover-d" id="works-grid">
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio1.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                                <h3 class="work-title">Corporate Identity</h3>
                                <div class="work-descr">Illustration</div>
                            </div></a></li>
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio2.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                                <h3 class="work-title">Bag MockUp</h3>
                                <div class="work-descr">Marketing</div>
                            </div></a></li>
                    <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio3.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                                <h3 class="work-title">Disk Cover</h3>
                                <div class="work-descr">Illustration</div>
                            </div></a></li>
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio4.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio5.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                            <div class="work-image"><img src="{{ asset('assets/fontend/images/portfolio/grid-portfolio6.jpg') }}" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="assets/fontend/images/team-1.jpg" alt="Member Photo"/>
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="assets/fontend/images/team-2.jpg" alt="Member Photo"/>
                                <div class="team-detail">
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="assets/fontend/images/team-4.jpg" alt="Member Photo"/>
                                <div class="team-detail">
        ...
        <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="{{ asset('assets/fontend/images/testimonial_bg.jpg') }}">
                    ...
                    <div class="col-sm-3">
                        <div class="widget">
                            ...
                            <ul class="widget-posts">
                                <li class="clearfix">
                                    <div class="widget-posts-image"><a href="#"><img src="assets/fontend/images/rp-1.jpg" alt="Post Thumbnail"/></a></div>
                                ...
                                <li class="clearfix">
                                    <div class="widget-posts-image"><a href="#"><img src="assets/fontend/images/rp-2.jpg" alt="Post Thumbnail"/></a></div>
                                    <div class="widget-posts-body">
